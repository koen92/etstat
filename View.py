...
class ServerDialog(QtGui.QDialog):
    ...
    def __init__(self, controller, parent):
        super(ServerDialog, self).__init__(parent, QtCore.Qt.WindowSystemMenuHint | QtCore.Qt.WindowTitleHint); #to hide the ? button
    ...
    def ok(self):
        ...
        try:
            ...
            QtGui.QMessageBox.warning(self, 'Ongeldig IP-adres', "Dit is geen geldig IP-adres, probeer opnieuw.");           
...
class Toolbar(QtGui.QWidget):
    ...
    def delServer(self):
        if ( self.servers.currentRow() > -1 and QtGui.QMessageBox.question(self, 'Vraag', "Weet je zeker dat je deze server  wilt verwijderen? Dit kan niet ongedaan gemaakt worden.", QtGui.QMessageBox.Yes | QtGui.QMessageBox.No, QtGui.QMessageBox.No) == QtGui.QMessageBox.Yes ):
            self.c.delServer(self.servers.cellWidget(self.servers.currentRow(), 1).text())
...
class View(QtGui.QWidget):
    ...
    def __init__(self):
        ...
        self.setWindowIcon(QtGui.QIcon("/usr/local/games/enemy-territory/ET.xpm"))
    ...
    def initUI(self, controller):
        ...
        self.servers.horizontalHeader().setResizeMode(QtGui.QHeaderView.Stretch);
        ...
        self.servers.setHorizontalHeaderItem(3,QtGui.QTableWidgetItem("Players"))
    ...
    def serverClicked(self):
        self.c.openServer(self.servers.cellWidget(self.servers.currentRow(), 1).text())
